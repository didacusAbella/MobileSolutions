...
<%@attribute name="phone" type="com.didacusabella.mobilesolutions.entities.Smartphone" required="true" rtexprvalue="true" %>
    ...
    <div class="media-object">
      ...
      <div class="media-object-section">
        ...
        <c:if test="${phone.bluetooth}">
          <p><strong>Bluettoth: </strong>Presente</p>
        </c:if>
          <p><input type="sumbit" class="button" value="Aggiungi Al Carrello"/></p>
      </div>
    </div>
  </div>
</div>