<form name="insertNote" action="inserimento" method="get" novalidate="true" data-abide>
  ...
  <div class="grid-container fluid">
    <div class="grid-x grid-padding-x">
      <div class="large-6 medium-6 small-12 cell">
        <label>Brand
          <input type="text" name="marca" placeholder="Inserisci Brand" required="true" pattern="alpha"/>
          <span class="form-error">Il brand deve essere composto da lettere</span>
        </label>
        <label>Modello
          <input type="text" name="dimensioni" placeholder="Inserisci Dimensioni" required="true" pattern="alpha_numeric"/>
          <span class="form-error">Il modello deve essere composto da lettere e numeri</span>
        </label>
        <label>Memoria Interna
          <input type="text" name="memoria" placeholder="Inserisci Memoria" required="true" pattern="integer"/>
      ...
      <div class="large-6 medium-6 small-12 cell">
        <label>Sistema Operativo
          <input type="text" name="os" placeholder="Inserisci Sistema Operativo" pattern="alpha_numeric" required="true"/>
          <span class="form-error">Il sistema operativo deve essere composto da lettere e numeri</span>
        </label>
        <label>Fotocamera
          <input type="text" name="fotocamera" placeholder="Inserisci Fotocamera" pattern="integer" required="true"/>
          <span class="form-error">La fotocamera deve essere composta da numeri</span>
        </label>
        <label>Risoluzione Schermo
          <input type="text" name="risSchermo" placeholder="Inserisci risoluzione" pattern="alpha_numeric" required="true"/>
