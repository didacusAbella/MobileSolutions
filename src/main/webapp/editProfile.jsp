            ...
            <div class="grid-x">
                ...
                <div class="cell">
                    <form name="editProfile" action="EditProfile" method="post" novalidate="true" data-abide>
                        ...
                        <label>CodiceFiscale:
                            <input type="text" value="${client.taxCode}" name="taxCode" required="true" minlength="2"
                                   maxlength="16" pattern="alpha_numeric"/>
                        ...
                        <label>CAP:
                            <input type="text" value="${client.cap}" name="cap" required="true" pattern="integer"
                                   minlength="4" maxlength="45"/>
                            <span class="form-error">Il campo CAP deve contenere solo numeri</span>
                        </label>
                        <label>Città:
                            <input type="text" value="${client.city}" name="city" pattern="alpha" required="true"
                        ...
                        <label>Telefono Cellulare:
                            <input type="text" value="${client.mobilePhone}" name="mobilePhone" required="true"
                                   pattern="integer" minlength="2" maxlength="14"/>
                            <span class="form-error">Il campo telefono deve contenere solo numeri</span>
                        </label>
                        <label>Username:
                            <input type="text" value="${client.username}" name="username" pattern="alpha_numeric"
                                   required="true" minlength="2" maxlength="16"/>
                            <span class="form-error">Il username deve contenere solo lettere o numeri</span>
                        </label>
                        <label>Email:
                            <input type="email" value="${client.email}" name="email" required="true" pattern="email"
                                   minlength="4" maxlength="25"/>
                            <span class="form-error">Il campo email non è valido</span>
                        </label>
                        <label>Telefono-Casa:
                            <input type="text" value="${client.telPhone}" name="telPhone" pattern="integer"
                                   required="true" minlength="2" maxlength="14"/>
                            <span class="form-error">Il campo telefono deve contenere solo numeri</span>
                        </label>
                        <label>Fax:
                            <input type="text" value="${client.fax}" name="fax" pattern="integer" required="true"
                                   minlength="2" maxlength="14"/>
                            <span class="form-error">Il campo fax deve contenere solo numeri</span>
                        </label>
                        <label>Password:
                            <input type="password" value="${client.password}" name="password" required="true"
                                   readonly="true" pattern="alpha_numeric" minlength="2" maxlength="20"/>
                    ...
                    <form name="deleteForm" method="post" action="DeleteAccount">
                        <input type="hidden" name="id" value="${client.id}" readonly="true"/>
